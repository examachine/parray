...
OBJS = Application.o Log.o Utility.o Parallel_Arrays.o

# Source Files

CXXFILES = Application.cxx Log.cxx Utility.cxx Parallel_Arrays.cxx
CCFILES =
CFILES =
AFILES =
INCFILES = General.hxx ANSI_Library.hxx Log.hxx Utility.hxx\
	Parallel_Arrays.hxx Interval.hxx Array.hxx Storage.hxx Algorithms.hxx\
	Storage_Classes.hxx Block_Partitioning.hxx Partition.hxx \
	Linear_Storage.hxx Expression.hxx Messages.hxx Array_IO.hxx\
	Array_Expression.hxx Component_Reference.hxx Functions.hxx \
	Array_Operators.hxx Expression_Operators.cxx
BUILDFILES = Makefile
GRAMMARFILES =
LEXFILES =
